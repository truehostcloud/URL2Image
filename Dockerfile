...
RUN apt install -y --no-install-recommends gunicorn xvfb wget libnss3 libxss1 libappindicator1 libindicator7 libsdl1.2-dev fonts-liberation libasound2 libatk-bridge2.0-0 libgtk-3-0 libnspr4 libnss3 libxtst6 lsb-release xdg-utils
...
RUN dpkg -i libindicator3-7_0.5.0-4_amd64.deb
RUN dpkg -i libappindicator3-1_0.4.92-7_amd64.deb
