...
RUN apt install -y --no-install-recommends gunicorn xvfb wget libnss3 libxss1 libsdl1.2-dev fonts-liberation libappindicator3-1 libasound2 libatk-bridge2.0-0 libgtk-3-0 libnspr4 libnss3 libxtst6 lsb-release xdg-utils
